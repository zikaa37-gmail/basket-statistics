...
export class AppService {
  ...
  getPlayers(): Player[] {
    return [
      { id: 2, firstName: 'Jovan', lastName: 'Milosevic', nickname: 'Joca', jerseyNumber: '1', selected: false, stats: new Stats() },
      { id: 3, firstName: 'Pavle', lastName: 'Zdero', nickname: 'Paja', jerseyNumber: '2', selected: false, stats: new Stats() },
      ...
      { id: 14, firstName: 'Mateja', lastName: 'Pacoski', nickname: 'Pacos', jerseyNumber: '19', selected: true, stats: new Stats() },
      { id: 13, firstName: 'Aleksandar', lastName: 'Markovic-Corac', nickname: 'Aca', jerseyNumber: '23', selected: null, stats: new Stats() },
      { id: 15, firstName: 'Bogdan', lastName: 'Bunjevac', nickname: 'Bunjevac', jerseyNumber: '24', selected: true, stats: new Stats() },
      { id: 16, firstName: 'Petar', lastName: 'Zivanovic', nickname: 'Zile', jerseyNumber: '27', selected: true, stats: new Stats() },
      { id: 17, firstName: 'Lazar', lastName: 'Djordjic', nickname: 'Djordjic', jerseyNumber: '30', selected: null, stats: new Stats() },
      { id: 18, firstName: 'Sergej', lastName: 'Basa', nickname: 'Basa', jerseyNumber: '77', selected: false, stats: new Stats() },
    ]
    // return [
    //   { id: 1, firstName: 'Filip', lastName: 'Mihailovic', nickname: 'Filip', jerseyNumber: '6', selected: null, stats: new Stats() },
